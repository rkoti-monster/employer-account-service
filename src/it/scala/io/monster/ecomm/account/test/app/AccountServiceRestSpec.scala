...
import io.monster.ecomm.account.test.environment.ItTestEnvironment
...
import io.monster.ecomm.account.test.util.K8sHelper.{ createConfigMap, deleteEnv, getEndpoint, startTestEnv }
import org.http4s.implicits._
import org.http4s.{ Method, Request }
import zio.ZIO
import zio.interop.catz._
import zio.test.Assertion.{ equalTo, isEmpty, isTrue }
...
object AccountServiceRestSpec extends DefaultRunnableSpec {

  private val account1 = Account("1", "Howdy!", None, None, None, None, None, None)
  private val newAccount1 = Account("1", "Well!", None, None, None, None, None, None)
  private val account2 = Account("2", "Howdy1!", None, None, None, None, None, None)
  private val nonExistingAccount = Account("100", "nonExistingAccount", None, None, None, None, None, None)
  private val client = createConfigMap(mysqlInitConfigMapName, mysqlInitFileName)
  private val endpoint =
    getEndpoint(startTestEnv(mysqlResourceFileName, Some(client)), mysqlServiceName, mysqlPortName)
  ...
  override def spec =
    suite("routes suite")(
      ...
      ItTestEnvironment(endpoint._1, endpoint._2.toInt).appEnvironmentLayer
    ) @@ sequential
}
